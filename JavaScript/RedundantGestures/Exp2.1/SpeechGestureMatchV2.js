  ...
  on_finish: function () {
    if (PRMS.cBlk >= 4) {
      window.location.assign(
        "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=426&credit_token=8295f10310084c7b8a2bf97a53299328&survey_code=" +
...
const CONSENT_SCREEN = {
  ...
  stimulus: generate_formatted_html({
    text: `Allgemeine Teilnahmeinformationen:<br><br>
               ...
               Vergütung: Für die Teilnahme am Experiment erhalten Sie 1.25 Versuchspersonenstunden.
...
const SONA_INSTRUCTIONS = {
  ...
  stimulus: generate_formatted_html({
    text: `<b>WICHTIG</b>:<br><br> Sie werden am Ende des Experiments 
              automatisch zu Sona weitergeleitet, wo Sie Ihre Versuchspersonenstunden 
...
const TASK_INSTRUCTIONS3 = {
  ...
  choices: [" "],
  stimulus: generate_formatted_html({
    text: `Wichtig: In der nachfolgenden ersten Hälfte des Experiments sollen Sie nur auf die GESTISCHE Antwort im Video reagieren! Um die linke 
...
const TASK_INSTRUCTIONS4 = {
  ...
  stimulus: generate_formatted_html({
    text: `Jetzt folgt zunächst ein kurzer Übungsblock, damit Sie sich mit der Aufgabe vertraut machen können. <br><br>
			  ...
			  Nutzen Sie den Übungsblock dazu, die Lautstärke so zu regulieren, dass Sie die Audio-Inhalte der Videos mühelos verstehen können.<br><br>
			  Reagieren Sie dennoch nur auf die GESTISCHEN Antworten!<br><br>
...
const TASK_INSTRUCTIONS5 = {
  ...
  stimulus: generate_formatted_html({
    text: `Ende des Übungsblocks! Das Experiment besteht aus ingesamt vier Blöcken. Nach jedem Block haben Sie die Möglichkeit,
			  ...
			  Denken Sie bis dahin bitte daran, ausschließlich auf die GESTISCHEN Antworten im Video zu reagieren! <br><br>
...
const TASK_INSTRUCTIONS6 = {
  ...
  stimulus: generate_formatted_html({
    text: `Die erste Hälfte des Experiments ist geschafft.<br>
		      ...
		      In der nachfolgenden zweiten Hälfte des Experiments reagieren Sie bitte nur auf die VERBALE Antwort im Video. <br><br>  
...
const TASK_INSTRUCTIONS7 = {
  ...
  stimulus: generate_formatted_html({
    text: `Es folgt wieder ein kurzer Übungsblock. Bitte denken Sie daran:<br>
		      Reagieren Sie ab jetzt auf die VERBALE Antwort im Video!<br><br>
...
const TASK_INSTRUCTIONS8 = {
  ...
  stimulus: generate_formatted_html({
    text: `Ende des Übungsblocks! Bitte denken Sie daran:<br>
		      Reagieren Sie auf die VERBALE Antwort im Video!<br><br>
...
const VIDEOS_A = [
  "../RequiredFiles/videos/JaDaumenhoch_f.mp4",
  "../RequiredFiles/videos/NeinDaumenhoch_f.mp4",
  "../RequiredFiles/videos/JaDaumenhoch_m.mp4",
  "../RequiredFiles/videos/NeinDaumenhoch_m.mp4",

  "../RequiredFiles/videos/JaDaumenrunter_f.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_f.mp4",
  "../RequiredFiles/videos/JaDaumenrunter_m.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_m.mp4",
  ...
  "../RequiredFiles/videos/JaDaumenhoch_f_no_gesture.mp4",
  "../RequiredFiles/videos/NeinDaumenhoch_f_no_gesture.mp4",
  "../RequiredFiles/videos/JaDaumenhoch_m_no_gesture.mp4",
  "../RequiredFiles/videos/NeinDaumenhoch_m_no_gesture.mp4",

  "../RequiredFiles/videos/JaDaumenrunter_f_no_gesture.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_f_no_gesture.mp4",
  "../RequiredFiles/videos/JaDaumenrunter_m_no_gesture.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_m_no_gesture.mp4",
];
...
const VIDEOS_B = [
  ...
  "../RequiredFiles/videos/JaDaumenhoch_f_no_sound.mp4",
  "../RequiredFiles/videos/JaDaumenrunter_f_no_sound.mp4",
  "../RequiredFiles/videos/JaDaumenhoch_m_no_sound.mp4",
  "../RequiredFiles/videos/JaDaumenrunter_m_no_sound.mp4",

  "../RequiredFiles/videos/NeinDaumenhoch_f_no_sound.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_f_no_sound.mp4",
  "../RequiredFiles/videos/NeinDaumenhoch_m_no_sound.mp4",
  "../RequiredFiles/videos/NeinDaumenrunter_m_no_sound.mp4",
];
...
const QUESTIONS = [
  "Ist der Ball in der grünen Box?",
  "Ist der Ball in der blauen Box?",
];
...
function drawQuestion(args) {
  ...
  ctx.fillText(
    args.question,
    PRMS.question_position[0],
    PRMS.question_position[1],
  );

  // boxes colour
  ctx.fillStyle = args.box_colour_left;
  ctx.fillRect(
    -PRMS.box_position[0] * 2,
    PRMS.box_position[1],
    PRMS.box_size,
    PRMS.box_size,
  );
...
const TRIAL_TABLE_PRACTICE_SPEECH = shuffle(create_trial_table_speech()).slice(
  0,
  PRMS.nTrlsP,
);
const TRIAL_TABLE_PRACTICE_GESTURE = shuffle(
  create_trial_table_gesture(),
).slice(0, PRMS.nTrlsP);
...
jsPsych.data.addProperties({ order: "gesture-speech" });
...
const END_MESSAGE = {
  ...
  stimulus:
    ...
    "<p><strong>Mit der Leertaste gelangen Sie zurück zu Sona, wo Ihnen die Versuchspersonenstunden</strong></p>" +
