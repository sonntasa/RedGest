  ...
  on_finish: function () {
    if (PRMS.cBlk >= 4) {
      window.location.assign(
        "https://uni-tuebingen.sona-systems.com/webstudy_credit.aspx?experiment_id=428&credit_token=dab20e5d6ed74825aa1b6c3df6334b21&survey_code=" +
...
const TASK_INSTRUCTIONS7 = {
  ...
  stimulus: generate_formatted_html({
    text: `Es folgt wieder ein kurzer Übungsblock. Bitte denken Sie daran:<br>
		      Reagieren Sie ab jetzt auf die VERBALEN Antwort im Video!<br><br>
...
const VIDEOS_A = [
  "../RequiredFiles/videos/JaKopfJa_f.mp4",
  "../RequiredFiles/videos/NeinKopfJa_f.mp4",
  "../RequiredFiles/videos/JaKopfJa_m.mp4",
  "../RequiredFiles/videos/NeinKopfJa_m.mp4",

  "../RequiredFiles/videos/JaKopfNein_f.mp4",
  "../RequiredFiles/videos/NeinKopfNein_f.mp4",
  "../RequiredFiles/videos/JaKopfNein_m.mp4",
  "../RequiredFiles/videos/NeinKopfNein_m.mp4",
  ...
  "../RequiredFiles/videos/JaKopfJa_f_no_gesture.mp4",
  "../RequiredFiles/videos/NeinKopfJa_f_no_gesture.mp4",
  "../RequiredFiles/videos/JaKopfJa_m_no_gesture.mp4",
  "../RequiredFiles/videos/NeinKopfJa_m_no_gesture.mp4",

  "../RequiredFiles/videos/JaKopfNein_f_no_gesture.mp4",
  "../RequiredFiles/videos/NeinKopfNein_f_no_gesture.mp4",
  "../RequiredFiles/videos/JaKopfNein_m_no_gesture.mp4",
  "../RequiredFiles/videos/NeinKopfNein_m_no_gesture.mp4",
];
...
const VIDEOS_B = [
  ...
  "../RequiredFiles/videos/JaKopfJa_f_no_sound.mp4",
  "../RequiredFiles/videos/JaKopfNein_f_no_sound.mp4",
  "../RequiredFiles/videos/JaKopfJa_m_no_sound.mp4",
  "../RequiredFiles/videos/JaKopfNein_m_no_sound.mp4",

  "../RequiredFiles/videos/NeinKopfJa_f_no_sound.mp4",
  "../RequiredFiles/videos/NeinKopfNein_f_no_sound.mp4",
  "../RequiredFiles/videos/NeinKopfJa_m_no_sound.mp4",
  "../RequiredFiles/videos/NeinKopfNein_m_no_sound.mp4",
];
