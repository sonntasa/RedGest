...
%                                In-File setup                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[man, hidelinks, floatsintext, 12pt, a4paper]{apa7}\usepackage[]{graphicx}\usepackage[]{xcolor}
...
\usepackage{alltt}
% \documentclass[man, hidelinks, floatsintext, 12pt, a4paper, draftall]{apa7}
\usepackage{setup}
...
\authorsnames{author1firstName author1secondName}
